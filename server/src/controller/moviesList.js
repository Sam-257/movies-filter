export default [

  {
    ...
    "plot": "Holden and Banky are comic book artists. Everythings going good for them until they meet Alyssa, also a comic book artist. Holden falls for her, but his hopes are crushed when he finds out shes gay.",
  ...
  },
  {
    ...
    "plot": "The lives of two mob hit men, a boxer, a gangsters wife, and a pair of diner bandits intertwine in four tales of violence and redemption.",
  ...
  },
  {
    ...
    "plot": "Oakland As general manager Billy Beanes successful attempt to assemble a baseball team on a lean budget by employing computer-generated analysis to acquire new players.",
  ...
  },
  {
    ...
    "plot": "When Gru, the worlds most super-bad turned super-dad has been recruited by a team of officials to stop lethal muscle and a host of Grus own, He has to fight back with new gadgetry, cars, and more minion madness.",
  ...
  },
  {
    ...
    "plot": "Traudl Junge, the final secretary for Adolf Hitler, tells of the Nazi dictators final days in his Berlin bunker at the end of WWII.",
  ...
  },
  {
    ...
    "genres": ["Crime", "Drama"],
    "director": "Tony Kaye",
    "actors": "Edward Norton, Edward Furlong, Beverly DAngelo, Jennifer Lien",
  ...
  },
  {
    ...
    "director": "Gore Verbinski",
    "actors": "Johnny Depp, Geoffrey Rush, Orlando Bloom, Keira Knightley",
    "plot": "Blacksmith Will Turner teams up with eccentric pirate \"Captain\" Jack Sparrow to save his love, the governors daughter, from Jacks former pirate allies, who are now undead.",
  ...
  },
  {
    ...
    "plot": "A veteran assigned to extract Earths remaining resources begins to question what he knows about his mission and himself.",
  ...
  },
  {
    ...
    "plot": "Nineteen-year-old Alice returns to the magical world from her childhood adventure, where she reunites with her old friends and learns of her true destiny: to end the Red Queens reign of terror.",
  ...
  },
  {
    ...
    "actors": "Matthew McConaughey, Jennifer Garner, Jared Leto, Denis OHare",
  ...
  },
  {
    ...
    "actors": "Brendan Gleeson, Chris ODowd, Kelly Reilly, Aidan Gillen",
  ...
  },
  {
    ...
    "plot": "During her familys move to the suburbs, a sullen 10-year-old girl wanders into a world ruled by gods, witches, and spirits, and where humans are changed into beasts.",
  ...
  },
  {
    ...
    "plot": "Illustrated upon the progress of his latest Broadway play, a former popular actors struggle to cope with his current life as a wasted actor is shown.",
  ...
  },
  {
    ...
    "plot": "Princess Fionas parents invite her and Shrek to dinner to celebrate her marriage. If only they knew the newlyweds were both ogres.",
  ...
  },
  {
    ...
    "plot": "While Frodo and Sam edge closer to Mordor with the help of the shifty Gollum, the divided fellowship makes a stand against Saurons new ally, Saruman, and his hordes of Isengard.",
